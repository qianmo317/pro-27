...
export const mockEmployees: Employee[] = [
  ...
  { id: '11', name: '黄十三', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=huangshisan', gender: 'male', phone: '13800138011', email: 'huangshisan@company.com', department: '技术部', position: '前端工程师', entryDate: '2022-01-10', status: 'active' },
  { id: '12', name: '杨十四', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=yangshisi', gender: 'female', phone: '13800138012', email: 'yangshisi@company.com', department: '产品部', position: '产品助理', entryDate: '2023-03-15', status: 'active' },
  { id: '13', name: '刘十五', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=liushiwu', gender: 'male', phone: '13800138013', email: 'liushiwu@company.com', department: '技术部', position: '后端工程师', entryDate: '2021-06-20', status: 'active' },
  { id: '14', name: '朱十六', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhushiliu', gender: 'female', phone: '13800138014', email: 'zhushiliu@company.com', department: '市场部', position: '市场经理', entryDate: '2020-08-01', status: 'active' },
  { id: '15', name: '秦十七', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=qinshiqi', gender: 'male', phone: '13800138015', email: 'qinshiqi@company.com', department: '人力资源部', position: 'HR 经理', entryDate: '2019-11-30', status: 'active' },
  { id: '16', name: '尤十八', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=youshiba', gender: 'female', phone: '13800138016', email: 'youshiba@company.com', department: '财务部', position: '会计', entryDate: '2022-02-15', status: 'active' },
  { id: '17', name: '许十九', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=xushijiu', gender: 'male', phone: '13800138017', email: 'xushijiu@company.com', department: '技术部', position: '测试工程师', entryDate: '2023-05-25', status: 'probation' },
  { id: '18', name: '何二十', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=heershi', gender: 'female', phone: '13800138018', email: 'heershi@company.com', department: '运营部', position: '运营专员', entryDate: '2022-04-18', status: 'active' },
  { id: '19', name: '吕廿一', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=lveryi', gender: 'male', phone: '13800138019', email: 'lveryi@company.com', department: '技术部', position: '运维工程师', entryDate: '2021-09-14', status: 'active' },
  { id: '20', name: '施廿二', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=shierer', gender: 'female', phone: '13800138020', email: 'shierer@company.com', department: '设计部', position: '平面设计师', entryDate: '2022-12-20', status: 'active' },
  { id: '21', name: '张廿三', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhangniansan', gender: 'male', phone: '13800138021', email: 'zhangniansan@company.com', department: '技术部', position: '全栈工程师', entryDate: '2022-05-15', status: 'active' },
  { id: '22', name: '李廿四', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=liniansi', gender: 'female', phone: '13800138022', email: 'liniansi@company.com', department: '产品部', position: '高级产品经理', entryDate: '2020-10-20', status: 'active' },
  { id: '23', name: '王廿五', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=wangnianwu', gender: 'male', phone: '13800138023', email: 'wangnianwu@company.com', department: '技术部', position: '后端架构师', entryDate: '2019-11-10', status: 'active' },
  { id: '24', name: '赵廿六', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhaonianliu', gender: 'female', phone: '13800138024', email: 'zhaonianliu@company.com', department: '市场部', position: '品牌专员', entryDate: '2023-01-05', status: 'active' },
  { id: '25', name: '孙廿七', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sunnianqi', gender: 'male', phone: '13800138025', email: 'sunnianqi@company.com', department: '人力资源部', position: '招聘专员', entryDate: '2022-03-30', status: 'active' }
]
